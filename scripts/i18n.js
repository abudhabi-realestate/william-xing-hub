SiteI18n.init({
  zh: {
    ...
    'vlog.title': 'Vlog · 阿布30天',
    'vlog.sub': 'Week 2 已更新 Day 1—9 · ADREC 数据系列 · 可收藏阅读',
    'vlog.hub.title': '阿布房产 30 天 · 系列目录',
    'vlog.hub.desc': '从认地图到三岛选型，系统建立阿布扎比买房框架。进入目录查看全部章节。',
  ...
  en: {
    ...
    'vlog.title': 'Vlog · Abu 30 Days',
    'vlog.sub': 'Week 2 · Day 1—9 · ADREC data series · Read & bookmark',
    'vlog.hub.title': 'Abu Dhabi Property · 30-Day Series',
    'vlog.hub.desc': 'From maps to the three islands — build your Abu Dhabi buying framework. View all chapters.',
